// ---------------------------------------------------
// Author: Chungtsn
// Url: www.dulichdau.com | www.101dian.com
// Version: 13.7 - Vietnamese
// Date: 12/14/2020
// ---------------------------------------------------
...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Có tổng ' + postTitle.length + ' bài<br/></span>'; }
   else {
...
function showToc() {
  ...
  else { alert("Chờ chút... danh mục đang được tạo"); }
}
